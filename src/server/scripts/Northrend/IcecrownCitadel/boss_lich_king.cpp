    ...
    public:
        ...
        struct boss_the_lich_kingAI : public BossAI
        {
            ...
            void JustReachedHome()
            {
                ...
                MistCore::GameObjectWorker<FrozenThroneResetWorker> worker(me, reset);
                    ...
                    switch (eventId)
                    {
                        ...
                        case EVENT_FROSTMOURNE_HEROIC:
                            if (TempSummon* terenas = me->GetMap()->SummonCreature(NPC_TERENAS_MENETHIL_FROSTMOURNE_H, TerenasSpawnHeroic, NULL, 60000))
                            {
                                ...
                                if (!triggers.empty())
                                {
                                    triggers.sort(MistCore::ObjectDistanceOrderPred(terenas, true));
                    ...
                    case POINT_CHARGE:
                        if (Player* target = ObjectAccessor::GetPlayer(*me, _grabbedPlayer))
                        {
                            ...
                            if (GameObject* platform = ObjectAccessor::GetGameObject(*me, _instance->GetData64(DATA_ARTHAS_PLATFORM)))
                            {
                                ...
                                triggers.sort(MistCore::ObjectDistanceOrderPred(me));
    ...
    public:
        ...
        class spell_the_lich_king_necrotic_plague_AuraScript : public AuraScript
        {
            ...
            void OnRemove(constAuraEffectPtr /*aurEff*/, AuraEffectHandleModes /*mode*/)
            {
                ...
                GetTarget()->CastCustomSpell(SPELL_NECROTIC_PLAGUE_JUMP, values, NULL, true, NULL, NULLAURA_EFFECT, GetCasterGUID());
...
class spell_the_lich_king_necrotic_plague_jump : public SpellScriptLoader
{
    public:
        ...
        class spell_the_lich_king_necrotic_plague_SpellScript : public SpellScript
        {
            ...
            {
                targets.sort(MistCore::ObjectDistanceOrderPred(GetCaster()));
                if (targets.size() < 2)
                    return;
    ...
    public:
        ...
        class spell_the_lich_king_valkyr_target_search_SpellScript : public SpellScript
        {
            ...
            void SelectTarget(std::list<WorldObject*>& targets)
            {
                ...
                _target = MistCore::Containers::SelectRandomContainerElement(targets);
                targets.clear();
        ...
        class spell_the_lich_king_harvest_soul_AuraScript : public AuraScript
        {
            ...
            void OnRemove(constAuraEffectPtr /*aurEff*/, AuraEffectHandleModes /*mode*/)
            {
                ...
                if (GetTargetApplication()->GetRemoveMode() == AURA_REMOVE_BY_DEATH)
                    GetTarget()->CastSpell((Unit*)NULL, SPELL_HARVESTED_SOUL, true, NULL, NULLAURA_EFFECT, GetTarget()->GetInstanceScript()->GetData64(DATA_THE_LICH_KING));
            }
